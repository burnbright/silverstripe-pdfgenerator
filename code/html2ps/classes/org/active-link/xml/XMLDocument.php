 ...
 */
import("org.active-link.xml.HTML2PSXML");
import("org.active-link.sys.HTML2PSFile");
...
class XMLDocument extends HTML2PSFile {
    ...
    function parseFromString($XMLDocString) {
		...
		$this->xml = new HTML2PSXML($xmlContents);
	}
