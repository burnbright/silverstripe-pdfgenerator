...
if (!defined('HTML2PS_DIR')) define('HTML2PS_DIR', dirname(__FILE__).DIRECTORY_SEPARATOR."html2ps".DIRECTORY_SEPARATOR);
...
define('CACHE_DIR', TEMP_FOLDER.'/html2pscache/');
...
// SHOULD BE OMITTED
define('WRITER_TEMPDIR',TEMP_FOLDER."/html2pstemp/");
